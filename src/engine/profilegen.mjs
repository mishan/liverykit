...
import { parseKn5, meshesUsingTexture, detailLayer, axisHints, axesFromWheels, discardsClear, motionBlurOnly, SHEET_SPAN } from './kn5.mjs';
...
export async function profileFromKn5(path, {
  ...
  // Said here and not only by --explain: without wheel centres no island is
  // marked as a wheel part, and the rims are then simply missing from bind.
