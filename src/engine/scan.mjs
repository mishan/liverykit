 ...
 * shader map does not give you a recolored car — it corrupts surface lighting.
 */
...
const REASONS = {
  'normal-map': 'normal map — encodes surface direction, not color; painting corrupts lighting',
  'normal-map?': 'large and uncompressed, almost certainly a normal map',
  'shader-map': 'AC shader map — gloss and reflectivity per texel, not color',
