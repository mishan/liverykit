...
- Unless the brief says otherwise, the number and the team name go on the doors as one group, laid out the same on both sides: a roundel about 400 mm across with the number filling about 70% of its height, and the team name directly below the roundel, centred under it, about 1.8 times the roundel's width and 150 mm tall, its letters clear of the disc. Find room for the whole group at once with find_space (about 730 mm wide by 600 mm tall), then lay the roundel, the number and the name out inside the spot it returns. A name on a rear quarter, a roof or a bumper is not where a spectator looks for it, and the critic does not count it as present.
